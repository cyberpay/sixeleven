...
// everywhere (and called just CSecret); in the current 611 implementation it is only used for
...
// Note: 611 implementation uses a hack: CSecret32 is used here, everywhere else
